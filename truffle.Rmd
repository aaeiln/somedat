...
map_world <- borders(database = "world", regions="France", colour = "grey50", fill = "#BCEDF6")  # We used the `Colour Picker` Addin to pick the colours
...
library("ggmap")
ggmap(bw_map) +
  geom_point(data = tuber_ecotypes$`k2$cluster`,
